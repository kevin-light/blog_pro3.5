# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-10-08 07:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='/static/avatar/tsl.jpg', max_length=200, null=True, upload_to='/static/avatar/%Y/%m', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=99, verbose_name='显示顺序(从小到大)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.EmailField(blank=True, max_length=100, null=True, verbose_name='个人网页地址')),
                ('data_publish', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('article', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Article', verbose_name='用户')),
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Comment', verbose_name='父级评价')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='文章')),
            ],
            options={
                'verbose_name': '评价',
